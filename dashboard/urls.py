...
urlpatterns = [
    ...
    path("members/activate/<int:pk>/", MemberActivateView.as_view(), name="member_activate"),
    path("members/deactivate/<int:pk>/", MemberDeactivateView.as_view(), name="member_deactivate"),
