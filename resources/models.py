...
class Resource(models.Model):
    ...
    image = models.ImageField("Resource Image", upload_to="resources/",null=True, blank=True)
    description = models.TextField("Resource Description",blank=True)
    url = models.URLField("Resource Video URL",blank=True, null=True)
    file = models.FileField("Resource attached file", upload_to="resources/file/", blank=True, null=True, validators=[ALLOWED_EXTENSIONS])
